...
assert_exists(Template(r"tpl1684118585256.png", record_pos=(0.402, -0.532), resolution=(1080, 2340)), "判断是否进入虚拟形象页面")
...
assert_equal(poco('com.starmakerinteractive.starmaker:id/v_menu_msg_input').get_text(), "一起聊聊", "判断是否进入KTV房间页面.")
